...
Servo 1 center = 2110, Servo 2 center = 2048
"""
import sys, os, time, numpy as np

# ---- fixed config ----
PORT = "COM8"          # change to COM5 / /dev/ttyUSB0 as needed
H_ID, V_ID = 1, 2
H_CENTER, V_CENTER = 2110, 2048
BAUD = 1000000
ACC = 80
KP, KD = 2.0, 0.5
JUMP = 0.08
...
class Gimbal:
    def __init__(self):
        ...
        self.pkt.WritePosEx(H_ID, H_CENTER, 500, ACC)
        self.pkt.WritePosEx(V_ID, V_CENTER, 500, ACC)
        print("gimbal ready")

    def move(self, h, v):
        hp = max(0, min(4095, int(H_CENTER + h * H_FACTOR)))
        vp = max(0, min(4095, int(V_CENTER + v * V_FACTOR)))
